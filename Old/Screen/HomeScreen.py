...
class HomeScreen(BaseScreen):
    ...
    def create_widgets(self):
        ...
        # 画像1の読み込みと表示
        image_path1 = "GroupWork/book_search_img.png"
        ...
        # 画像2の読み込みと表示
        image_path2 = "GroupWork/book_shelf_img.png"
        ...
        # ボタンの作成
        book_search_screen_button = tk.Button(self.root, text="検索", command=on_book_search_screen_button_click,font=button_font)
        book_shelf_screen_button = tk.Button(self.root, text="本棚", command=on_book_shelf_screen_button_click,font=button_font)
