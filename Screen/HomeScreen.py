...
class HomeScreen(BaseScreen):
    ...
    def create_widgets(self):
        ...
        title_label = tk.Label(self.root, text=title_name, font=title_font)
        ...
        resized_image1 = original_image1.resize((200, 200), Image.ANTIALIAS if hasattr(Image, 'ANTIALIAS') else Image.LANCZOS)
        ...
        resized_image2 = original_image2.resize((200, 200), Image.ANTIALIAS if hasattr(Image, 'ANTIALIAS') else Image.LANCZOS)
        ...
        # 画像がクリックされたときの処理を設定
        image_label1.bind("<Button-1>", lambda event: self.on_book_search_screen_button_click())
        image_label2.bind("<Button-1>", lambda event: self.on_book_shelf_screen_button_click())
        ...
        # ボタンの作成
        book_search_screen_button = tk.Button(self.root, text="検索", command=self.on_book_search_screen_button_click,font=button_font)
        book_shelf_screen_button = tk.Button(self.root, text="本棚", command=self.on_book_shelf_screen_button_click,font=button_font)
